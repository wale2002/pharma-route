...
export default function Login() {
  ...
  const demoCredentials = [
    { role: 'clinic', email: 'clinic@medilink.com', icon: Stethoscope, color: 'text-primary' },
    { role: 'pharmacy', email: 'pharmacy@medilink.com', icon: Pill, color: 'text-secondary' },
    { role: 'rider', email: 'rider@medilink.com', icon: Truck, color: 'text-accent' }
  ];
